...
const OurTeamSection = () => (
  <section
    id="team"
    className="relative lg:w-full text-[#1c1c1c] flex  matrix-background flex-col flex-grow z-10"
  >
      ...
      <header className="bg-transparent flex justify-center w-full">
        <div className="flex justify-center pt-20 mb-8">
          <div className="bg-purple text-black px-8 py-2 rounded-full shadow-lg">
            <h1 className="text-3xl md:text-4xl lg:text-5xl text-neonpurple font-spy italic uppercase drop-shadow-glow text-shadow-purple-glow text-center">TEAM</h1>
          </div>
        </div>
      </header>
