    ...
    <section id="about" className="relative">
      ...
      <div className="flex flex-col gap-y-12 md:gap-y-5 py-10 md:py-0 mx-10 my-5 md:flex-row md:justify-around md:gap-x-5 md:my-5">
        ...
        <div className={`flex-1 md:py-20 md:px-10 md:w-3/4`}>
          <div className=" relative z-20 text-2xl md:text-3xl lg:text-4xl text-neonpurple font-spy italic uppercase drop-shadow-glow text-shadow-purple-glow">
            What is Hack Dearborn?
          </div>
          <div
            className={`relative z-20 mt-2 text-xl lg:text-xl md:h-auto  text-white font-klein`}
          >
