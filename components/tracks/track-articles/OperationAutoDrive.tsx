    ...
    <article className="text-center lg:text-left lg:mb-8 grid grid-cols-1 gap-4 lg:flex lg:flex-row lg:items-center">
      <div className="relative lg:flex-1 flex items-center justify-center">
        <div className="relative">
          <Image
            src="/Automotive-Track.svg"
            alt="Operation Auto-Drive"
            width={400}
            height={400}
          />
      ...
      <div className="lg:flex-1 px-5 lg:px-0 md:px-25">
        ...
        >
          <span className="text-purple">Explore</span> the evolving world of
          intelligent<span className="font-sans">,</span> connected vehicles
          <span className="font-sans">. </span> This track challenges
          participants to uncover new{" "}
          <span className="text-purple">possibilities</span> in mobility
          <span className="font-sans">,</span> from autonomous systems to
          futuristic in-car experiences
          <span className="font-sans">. </span>Unlocking new possibilities for
          vehicle technology or redefining how we{" "}
          <span className="text-purple">connect</span> with our surroundings on
          the move<span className="font-sans">.</span>
        </p>
      </div>
    </article>
  );
